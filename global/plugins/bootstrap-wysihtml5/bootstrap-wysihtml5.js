!function($, wysi) {
    ...
    var tpl = {
        ...
        "emphasis": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn default" + size + "' data-wysihtml5-command='bold' title='CTRL+B' title='" + locale.emphasis.bold + "'  tabindex='-1'> <i class='fa fa-bold'></i> </a>" +
                "<a class='btn default" + size + "' data-wysihtml5-command='italic' title='CTRL+I'  title='" + locale.emphasis.italic + "' tabindex='-1'> <i class='fa fa-italic'></i> </a>" +
                "<a class='btn default" + size + "' data-wysihtml5-command='underline' title='CTRL+U' title='" + locale.emphasis.underline + "'  tabindex='-1'> <i class='fa fa-underline'></i> </a>" +
              "</div>" +
            "</li>";
        },
